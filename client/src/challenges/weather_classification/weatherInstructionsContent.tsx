...
export const instructionsContent = {
  ...
  challenge: {
    ...
    description:
      "You're stepping into the shoes of a Weather Wizard, using the power of AI to predict whether it's going to be sunny, rainy, or something else! Using days upon days of weather recordings, your mission is to build a machine learning model that forecasts like a pro-meteorologist. Can you crack the weather code?"
  },
  instructions: {
